  ...
  return (
    <div className="bg-savedImg bg-cover w-full bg-no-repeat lg:h-[100vh] h-auto">
      ...
      <div className="relative w-[80%] mx-auto pt-10">
        <div className="bg-white p-2 rounded-full w-[65px]">
          <Link to="/">
        ...
        <div className="text-center text-white pt-10 space-y-8 font-semibold">
          ...
          {savedWeather.length === 0 && (
            <p className="text-base">
              You do not have a location saved yet. Your saved location will
              show up here when you save them.
            </p>
          )}
          <div className="lg:grid lg:grid-cols-3 gap-5 space-y-4 lg:space-y-0">
